<div align="center">
  ...
  <br/>
  <h1>🎓 UniMS</h1>
  <p><b>Hệ thống quản lý đại học và sinh viên tự lưu trữ (Self-hosted)</b></p>
  <p>Phân quyền mạnh mẽ · Dữ liệu của bạn · Trợ lý AI · Vanilla JS</p>
...
<div align="center">
  <p><b>Hệ thống quản lý đại học mà bạn thực sự sở hữu.</b></p>
  <p>Lên kế hoạch học tập, quản lý điểm số, và theo dõi tiến độ sinh viên qua từng học kỳ — ngay trên trình duyệt, siêu nhanh và mượt mà. Đăng nhập phân quyền mạnh mẽ, không cần cài đặt phức tạp. Tất cả gói gọn trong một lệnh <code>python server.py</code>.</p>
</div>

<div align="center">
  <img src="https://img.shields.io/badge/license-MIT-green.svg" alt="License">
  <img src="https://img.shields.io/badge/self--hosted-%F0%9F%8F%A0-blue.svg" alt="Self-hosted">
  <img src="https://img.shields.io/badge/UI-Vanilla%20JS-yellow.svg" alt="Vanilla JS">
  <img src="https://img.shields.io/badge/backend-Python%20Server-3776AB.svg?logo=python" alt="Python">
  <img src="https://img.shields.io/badge/telemetry-none-ff69b4.svg" alt="No telemetry">
</div>
